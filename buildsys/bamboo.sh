...
#    fi
    ...
    case $1 in
        ...
        # ====                                                            ====
        # ====================================================================
        sstmainline_config_dist_test|sstmainline_config_make_dist_no_gem5|sstmainline_config_make_dist)
            #-----------------------------------------------------------------
